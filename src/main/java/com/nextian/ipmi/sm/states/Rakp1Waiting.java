 ...
 * <li> {@link Rakp1Complete} on {@link DefaultAck}
 * <li> {@link Authcap} on {@link Timeout}
 */
    ...
    public void doAction(StateMachine stateMachine, RmcpMessage message) throws InterruptedException {
        ...
        try {
            ...
            if (rakp1.isCommandResponse(ipmiMessage) &&
                ...
                stateMachine.doExternalAction(new ResponseAction(CompletionCode.Ok, rakp1.getResponseData(ipmiMessage)));
            }
