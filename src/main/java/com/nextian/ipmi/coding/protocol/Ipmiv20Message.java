...
public class Ipmiv20Message extends IpmiMessage {
     ...
     * Length byte.
     *
     * @param encoder {@link IpmiEncoder} to be used to convert message to byte array format. Must be able to handle
     *                null authCode field with  {@link #isPayloadAuthenticated()} == true  since this method is used
     *                in its generation.
