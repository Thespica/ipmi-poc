...
public class RmcpPingMessage extends RmcpMessage {
     ...
     *
     * @param sequenceNumber used for pairing request with response. Can't be 255.
     * @throws IllegalArgumentException when sequence number is 255.
     */
    ...
    private byte[] preparePingMessage(int sequenceNumber) {
        ...
        System.arraycopy(TypeConverter.intToByteArray(RmcpConstants.ASFIANA), 0, message, 0, 4);
