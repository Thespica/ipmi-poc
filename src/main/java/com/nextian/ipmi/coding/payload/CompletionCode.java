...
public enum CompletionCode {
    ...
    /**
     * Get completion code integer value
     *
     * @return complation code value
     */
    public int getCode() {
        return code;
    }
    ...
    /**
     * Convert IPMI byte code to is appropriate enumeration object.
     *
     * @param value integer value of IPMI completion code
     * @return enum value of corresponding integer value
     */
    ...
    /**
     * Get message associated with ComplationCode enum.
     *
